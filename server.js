...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, connect_1["default"])(process.env.MONGODB_URL)];
            case 1:
                _a.sent();
                app.listen(port, function () {
                    console.log(chalk_1["default"].green.bold("[server]: Server is running at http://localhost:".concat(port, "...")));
                });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
